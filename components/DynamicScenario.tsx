        ...
        <div className="min-h-screen bg-theme-bg text-theme-text pb-20">
            ...
            <div className="bg-theme-panel/80 border-b border-theme-border-s sticky top-0 z-10 backdrop-blur-xl">
                <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
                    ...
                    <div className="flex gap-4 items-center text-sm">
                        <span className="text-theme-muted">{getThemeLabel(props.theme)}</span>
            ...
            <main className="max-w-4xl mx-auto px-6 py-8">
                ...
                <div className="mb-8">
                    ...
                    {props.summary && (
                        <p className="text-xl text-theme-muted leading-relaxed">{props.summary}</p>
                    )}
                    {props.focusArea && (
                        <div className="mt-4">
                            <span className="inline-block px-3 py-1 bg-surface-inset border border-theme-border rounded-full text-xs text-theme-muted">
                ...
                <section className="mb-8">
                    <div className="bg-theme-panel border border-theme-border rounded-xl p-6">
                        ...
                        <div className="text-theme-body leading-relaxed whitespace-pre-wrap">
                            {props.context}
                        </div>
                    </div>
                </section>
                ...
                {!showAnswers && (
                    <section className="mb-8 text-center">
                        <div className="bg-theme-panel/50 border border-theme-border-s rounded-xl p-8">
                ...
                {showAnswers && (
                    <div className="space-y-8">
                        ...
                        {badAnswer && (
                            <section>
                                <div className="bg-theme-panel border border-red-900/30 rounded-xl overflow-hidden">
                                    ...
                                    <div className="p-6">
                                        <div className="text-theme-body leading-relaxed whitespace-pre-wrap mb-6">
                                            {badAnswer.content}
                                        </div>
                                        <div className="bg-red-900/10 border border-red-900/20 rounded-lg p-4">
                                            ...
                                            <p className="text-theme-muted text-sm whitespace-pre-wrap">{badAnswer.analysis}</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        {goodAnswer && (
                            <section>
                                <div className="bg-theme-panel border border-blue-900/30 rounded-xl overflow-hidden">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="bg-blue-900/10 border border-blue-900/20 rounded-lg p-4">
                                            ...
                                            <p className="text-theme-muted text-sm whitespace-pre-wrap">{goodAnswer.analysis}</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        {bestAnswer && (
                            <section>
                                <div className="bg-theme-panel border border-green-900/30 rounded-xl overflow-hidden">
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="bg-green-900/10 border border-green-900/20 rounded-lg p-4">
                                            ...
                                            <p className="text-theme-muted text-sm whitespace-pre-wrap">{bestAnswer.analysis}</p>
                                        </div>
                                    </div>
                                </div>
                            </section>
                            ...
                            <div className="bg-theme-panel border border-theme-border rounded-xl p-6">
                                ...
                                <ul className="space-y-3">
                                    {props.keyTakeaways.map((takeaway, index) => (
                                        <li key={index} className="flex gap-3 text-theme-body">
