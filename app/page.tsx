...
export default function Home() {
    return (
        <main className="min-h-screen bg-theme-bg text-theme-text selection:bg-accent-900 selection:text-accent-300">
                ...
                <div className="container-wide text-center relative">
                    ...
                    <div className="flex flex-col items-center animate-fade-in-up [animation-delay:300ms]">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center">
                            ...
                            <span className="hidden sm:block text-theme-muted">|</span>
                            <Link href="#how-it-works" className="text-sm text-theme-muted hover:text-theme-text transition flex items-center gap-2">
            ...
            <section className="py-24 bg-theme-bg relative">
                ...
                <div className="container-wide max-w-4xl relative">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-theme-panel border border-accent-900/50 rounded-xl p-8 shadow-2xl glow-cyan">
                            ...
                            <div className="space-y-6 font-mono text-sm">
                                <div className="p-4 bg-surface-faint rounded-lg border border-theme-border-s opacity-60">
                                    <strong className="text-red-400 block mb-2 text-xs tracking-wide">BAD ANSWER — WEAK SIGNAL</strong>
                                    <p className="text-theme-muted">&ldquo;I&apos;d use Kafka here for the messaging queue because it scales well and is standard.&rdquo;</p>
                                </div>
                    ...
                    <div className="mt-12 grid md:grid-cols-2 gap-8">
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-theme-muted text-sm">Navigate ambiguity, articulate assumptions, and defend engineering judgment when tradeoffs are unclear.</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-theme-muted text-sm">Reason about failure modes, scalability limits, and performance under constraints that textbooks skip.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* 3. HOW IT WORKS */}
            <section id="how-it-works" className="py-24 bg-theme-panel border-y border-theme-border-s relative">
                ...
                <div className="container-wide max-w-4xl relative">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-theme-muted">No typing, no gamification. Pure calibration against the Principal bar.</p>
                    </div>

                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="group p-8 rounded-xl bg-theme-bg border border-theme-border-s hover:border-accent-800/50 transition-all hover:glow-cyan">
                            ...
                            <p className="text-theme-muted text-sm leading-relaxed">A realistic system design problem with production constraints, team dynamics, and business context—not a sanitized textbook prompt.</p>
                        </div>
                        ...
                        <div className="group p-8 rounded-xl bg-theme-bg border border-theme-border-s hover:border-accent-800/50 transition-all hover:glow-cyan">
                            ...
                            <p className="text-theme-muted text-sm leading-relaxed">Pause and think through your approach before seeing ours. This active recall is what builds interview muscle memory.</p>
                        </div>
                        ...
                        <div className="group p-8 rounded-xl bg-theme-bg border border-theme-border-s hover:border-accent-800/50 transition-all hover:glow-cyan">
                            ...
                            <p className="text-theme-muted text-sm leading-relaxed">See exactly why a &ldquo;Senior&rdquo; answer falls short of the &ldquo;Principal&rdquo; bar. Each criterion is broken down with the interviewer&apos;s rubric.</p>
                        </div>
                        ...
                        <div className="group p-8 rounded-xl bg-theme-bg border border-theme-border-s hover:border-accent-800/50 transition-all hover:glow-cyan">
                            ...
                            <p className="text-theme-muted text-sm leading-relaxed">Reflection prompts and a mock interviewer dialogue help you absorb the patterns that distinguish principal-level thinking.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* 4. FREE SAMPLES */}
            <section id="samples" className="py-24 bg-theme-bg">
                <div className="container-wide">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-theme-muted max-w-2xl mx-auto">Experience the full interview simulation format. These are real scenarios at the Principal bar—not watered-down teasers.</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                        <Link href="/samples/scenario-1" className="group p-6 rounded-xl bg-theme-panel border border-theme-border-s hover:border-violet-600/30 transition-all hover:-translate-y-1 hover:glow-violet">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-xs text-theme-muted">30 min</span>
                            </div>
                            <h3 className="text-lg font-semibold mb-2 group-hover:text-accent-400 transition">Distributed Rate Limiter</h3>
                            <p className="text-theme-muted text-sm mb-4">Design a rate limiting system for 5M RPS with sub-5ms latency overhead.</p>
                        ...
                        <Link href="/samples/scenario-2" className="group p-6 rounded-xl bg-theme-panel border border-theme-border-s hover:border-accent-700/30 transition-all hover:-translate-y-1 hover:glow-cyan">
                            <div className="flex items-center gap-2 mb-3">
                                ...
                                <span className="text-xs text-theme-muted">25 min</span>
                            </div>
                            <h3 className="text-lg font-semibold mb-2 group-hover:text-accent-400 transition">Microservices vs Monolith</h3>
                            <p className="text-theme-muted text-sm mb-4">Navigate the build vs. migrate decision with real constraints and team dynamics.</p>
                            <span className="text-accent-400 text-sm font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
                                Start scenario
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M5 12h14M12 5l7 7-7 7" />
                        ...
                        <Link href="/samples/scenario-3" className="group p-6 rounded-xl bg-theme-panel border border-theme-border-s hover:border-accent-700/30 transition-all hover:-translate-y-1 hover:glow-cyan">
                            <div className="flex items-center gap-2 mb-3">
                                <span className="px-2 py-0.5 text-xs font-medium rounded bg-red-500/10 text-red-400 border border-red-500/20">Tactical</span>
                                <span className="text-xs text-theme-muted">20 min</span>
                            </div>
                            <h3 className="text-lg font-semibold mb-2 group-hover:text-accent-400 transition">API Performance Crisis</h3>
                            <p className="text-theme-muted text-sm mb-4">Debug latency spikes in production with real metrics and time pressure.</p>
                            <span className="text-accent-400 text-sm font-medium flex items-center gap-1 group-hover:gap-2 transition-all">
                                Start scenario
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M5 12h14M12 5l7 7-7 7" />
                    ...
                    <div className="text-center mt-10">
                        <Link href="/archive" className="inline-flex items-center gap-2 text-theme-muted hover:text-theme-text transition text-sm">
            ...
            {/* 5. PRICING */}
            <section id="pricing" className="py-24 bg-theme-panel border-y border-theme-border-s relative">
                ...
                <div className="container-wide max-w-4xl relative">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-theme-muted">Less than one hour of interview prep coaching—delivered every day for a month.</p>
                    </div>

                    <div className="grid md:grid-cols-2 gap-8">
                        {/* Monthly */}
                        <div className="p-8 rounded-2xl bg-theme-bg border border-theme-border flex flex-col">
                            <h3 className="text-xl font-bold mb-2">Monthly</h3>
                            <div className="mb-2"><span className="text-4xl font-bold">$20</span><span className="text-theme-muted">/mo</span></div>
                            <p className="text-theme-muted text-sm mb-6">Full access, cancel anytime</p>
                            <ul className="space-y-4 mb-8 flex-1">
                                <li className="flex gap-3 text-theme-body text-sm"><span className="text-accent-400">&#10003;</span> Daily Interview Scenarios</li>
                                <li className="flex gap-3 text-theme-body text-sm"><span className="text-accent-400">&#10003;</span> Full Archive Access</li>
                                <li className="flex gap-3 text-theme-body text-sm"><span className="text-accent-400">&#10003;</span> Bad/Good/Best Analysis</li>
                                <li className="flex gap-3 text-theme-body text-sm"><span className="text-accent-400">&#10003;</span> Cancel Anytime</li>
                            </ul>
                            <PricingButton
                                plan="monthly"
                                className="w-full py-3 rounded-lg border border-theme-border hover:bg-surface-inset hover:border-accent-800/50 transition font-semibold"
                            >
                                Start Monthly
                            </PricingButton>
                        </div>
                        ...
                        <div className="p-8 rounded-2xl bg-accent-900/10 border border-accent-700/30 flex flex-col relative overflow-hidden glow-cyan">
                            ...
                            <h3 className="text-xl font-bold mb-2 text-theme-text">Annual</h3>
            ...
            <section className="py-24 bg-theme-bg">
                <div className="container-wide max-w-2xl">
                    ...
                    <div className="space-y-4">
                        <details className="group rounded-lg p-4 cursor-pointer border border-theme-border-s bg-theme-panel/50 hover:border-accent-900/50 transition-colors">
            ...
            {/* FOOTER */}
            <footer className="py-16 bg-theme-bg border-t border-theme-border-s">
                <div className="container-wide">
                    <div className="grid md:grid-cols-4 gap-12 mb-12">
                        <div className="md:col-span-2">
                            <div className="text-lg font-bold mb-4 text-theme-text">DailyDesign</div>
                        ...
                        <div>
                            <h4 className="text-sm font-semibold mb-4 text-theme-text">Scenarios</h4>
                            <ul className="space-y-2 text-sm text-theme-muted">
                                <li><Link href="/samples/scenario-1" className="hover:text-theme-text transition">Rate Limiter Design</Link></li>
                                <li><Link href="/samples/scenario-2" className="hover:text-theme-text transition">Microservices Decision</Link></li>
                                <li><Link href="/samples/scenario-3" className="hover:text-theme-text transition">Performance Debugging</Link></li>
                                <li><Link href="/archive" className="hover:text-theme-text transition">Browse Archive &rarr;</Link></li>
                            </ul>
                        </div>
                        <div>
                            <h4 className="text-sm font-semibold mb-4 text-theme-text">Company</h4>
                            <ul className="space-y-2 text-sm text-theme-muted">
                                <li><a href="#pricing" className="hover:text-theme-text transition">Pricing</a></li>
                                <li><Link href="/terms" className="hover:text-theme-text transition">Terms of Service</Link></li>
                                <li><Link href="/privacy" className="hover:text-theme-text transition">Privacy Policy</Link></li>
                                <li><a href="mailto:support@dailydesign.dev" className="hover:text-theme-text transition">Contact</a></li>
                                <li><ManageSubscription /></li>
                            </ul>
                        </div>
                    </div>
                    <div className="pt-8 border-t border-theme-border-s flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-theme-muted text-xs">&copy; 2026 DailyDesign. Not affiliated with any big tech company.</p>
                        <div className="flex gap-6 text-xs text-theme-muted">
                            <span className="text-theme-muted">DailyDesign</span>
                        </div>
                    </div>
                </div>
            </footer>
