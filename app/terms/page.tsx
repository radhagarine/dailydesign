    ...
    <main className="min-h-screen bg-theme-bg text-theme-text">
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-gray max-w-none space-y-8 text-theme-body leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">1. Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">2. Service Description</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">3. Educational Content Disclaimer</h2>
            <p>
              All scenarios, interview questions, and company contexts presented in DailyDesign content are <strong className="text-theme-text">fictional and for educational purposes only</strong>. They do not represent real interview questions from any company. We make no guarantee of interview success or employment outcomes from using this service.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">4. Subscriptions and Billing</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">5. Refund Policy</h2>
            <p>
              We offer a <strong className="text-theme-text">7-day refund policy</strong>. If you are unsatisfied with the service, contact us within 7 days of your initial subscription payment for a full refund. Refunds after the 7-day window are at our discretion.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">6. Free Tier</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">7. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">8. Intellectual Property</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">9. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">10. Changes to Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-theme-text mb-3">11. Contact</h2>
            <p>
