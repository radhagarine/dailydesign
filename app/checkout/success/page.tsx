        ...
        return (
            <main className="min-h-screen bg-theme-bg text-theme-text flex items-center justify-center">
                <div className="text-center">
                    <div className="h-20 w-20 bg-surface-inset rounded-full mb-6 mx-auto animate-pulse" />
                    <p className="text-theme-muted">Verifying your payment...</p>
                </div>
            </main>
        );
    }
    ...
    return (
        <main className="min-h-screen bg-theme-bg text-theme-text flex items-center justify-center px-4">
            <div className="max-w-md w-full text-center">
                ...
                {/* Receipt info */}
                <p className="mt-8 text-theme-muted text-sm">
